...
uv_buf_t hs_alloc_buffer(uv_handle_t *handle, size_t suggested_size)
{
 ...
 * @param buf
 */
void hs_expect_client_response(uv_stream_t* client, ssize_t nread, uv_buf_t buf)
{
...
void hs_read_buffer(uv_stream_t* client, ssize_t nread, uv_buf_t buf)
{
    uv_buf_t out_buf;
    bls_handshake_t *hs = (bls_handshake_t *) client->data;
