...
RtmpProtocol::~RtmpProtocol()
{
    ...
    {
        v8::String::New(uv_err_name(uv_last_error(uv_default_loop()))),
        v8::Number::New(total_recved_size),
        v8::Number::New(client->bls_socket->send_bytes)
    };
    client->node_on_close_cb->Call(
            v8::Context::GetCurrent()->Global(), 3, argv_res);
#endif
