...
time_t xtimezoneoffset();
time_t xroundtime(const com_device_t& device, time_t now);
int save_backup(const char *file, char *dest, int siz, 
                const char *fmt = NULL, time_t bck_t = 0, bool recur = true);
